        ...
        <div className="landing-page">
            ...
            <div className="hero-section" style={{ minHeight: '55vh', height: 'auto', paddingTop: 'calc(var(--navbar-height) + 5rem)', paddingBottom: '5rem' }}>
                ...
                <div className="hero-content">
                    <div className="code-lab-by">AFFORDABLE PRICING PLANS</div>
            ...
            <main className="main-content">
                ...
                <section className="content-section fade-in" style={{ textAlign: 'center' }}>
                    <div className="section-container">
                        <h2 className="college" style={{ fontSize: '64px' }}>HAVE A BETTER OFFER IN MIND?</h2>
                        <div className="section-content" style={{ maxWidth: '600px', margin: '0 auto 2.5rem' }}>
                            <p>We are open for negotation. We would love to hear from you.</p>
                        </div>
                        <div className="cta-buttons">
                            ...
                            <a href="/" className="secondary-btn" style={{ padding: '0.8rem 2rem', fontFamily: "'Barlow Condensed', sans-serif", fontSize: '1rem', fontWeight: 700, letterSpacing: '2px', textTransform: 'uppercase', borderRadius: '4px', background: '#2e66d4', color: '#fff', border: '2px solid #2e66d4', display: 'inline-block' }}>Make an offer</a>
                        </div>
                    </div>
                </section>
